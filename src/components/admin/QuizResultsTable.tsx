...
interface QuizResultsTableProps {
  users: UserQuizResult[];
  onRowClick: (user: UserQuizResult) => void;
  searchTerm: string;
            ...
            {isLoading ? (
              ...
              users.map((user, index) => (
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <span className="text-gray-600">{user.totalQuizzes}</span>
                  </td>
                  <td className="px-6 py-4">
                    <span className="text-gray-600">{user.averageScore}%</span>
                  </td>
