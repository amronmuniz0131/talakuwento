...
export default function MyBook(props: any) {
    ...
    return (
        ...
        <div className="bg-black">
            <div className="flex">
                <div className="flex">
                    <svg className={`transition-all duration-500 ease-in-out ${selected ? 'animate-shake' : ''}`} width="491" height="670" viewBox="0 0 491 670" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={() => { setSelected(!selected), showFruits(!selected) }}>
                    ...
                    <svg onClick={() => { setMountain(!openMountain) }} width="670" height="491" viewBox="0 0 5266 2942" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg onClick={() => { setSelectedStory(!selectedStory) }} className={`${selectedStory && 'transition-opacity duration-1000 opacity-0 ease-in'}`} width="289" height="211" viewBox="0 0 289 211" fill="none" xmlns="http://www.w3.org/2000/svg">
