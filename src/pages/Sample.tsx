...
import makilingBg from '../images/mountain.png';
...
export default function MyBook(props: any) {
    ...
    return (
        // @ts-ignore
        // <HTMLFlipBook width={dimensions.width / 2} height={dimensions.height} disableFlipByClick={true}>
        ...
        //             <div>
        //                 Noong unang panahon, sa lalawigan ng Laguna, may isang mataas at luntiang bundok na tinatawag ngayong Bundok Makiling. Doon naninirahan ang isang diwata na kilala sa pangalang Maria Makiling.
        //             </div>
        //         </div>
        //     </div>
        //     <div className="overflow-hidden ">
        //         <div className="flex bg-cover bg-center" style={{ backgroundImage: `url(${makilingBg})` }} >
        ...
        //                 <img src={makiling} alt="" onClick={(e) => { e.stopPropagation(); setMountain(!openMountain); console.log('test2') }} className={`hover:cursor-pointer absolute bottom-0 left-0 ${!openMountain ? 'animate-fade opacity-0' : 'animate-show opacity-100'}`} />
        ...
        // </HTMLFlipBook>
        <div className="bg-green-200 h-screen overflow-auto">
            <div className="flex">
                <div className="block relative md:flex w-full h-screen">
                    <svg className={`w-full max-w-[491px] h-auto transition-all duration-500 ease-in-out ${selected ? 'animate-shake' : ''}`} viewBox="0 0 491 670" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={() => { setSelected(!selected), showFruits(!selected) }}>
                        <defs>
                            <linearGradient id="ellipse-grad" x1="0%" y1="0%" x2="0%" y2="100%">
                                <stop offset="0%" stopColor="#23362b" />
                                <stop offset="100%" stopColor="#486e58" />
                            </linearGradient>
                        </defs>
                        ...
                        <ellipse cx="215.5" cy="188.5" rx="145.5" ry="115.5" fill="url(#ellipse-grad)" />
                        <ellipse cx="181.5" cy="163" rx="152.5" ry="121" fill="url(#ellipse-grad)" />
                        ...
                        <ellipse cx="204.5" cy="147.5" rx="112.5" ry="89.5" fill="url(#ellipse-grad)" />
                    ...
                    <svg onClick={() => { setMountain(!openMountain) }} className="w-full h-auto max-w-[50vw]" viewBox="0 -1920 5266 2942" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path className={`${!openMountain ? "animate-move-up translate-y-[-1080px]" : "animate-move-down translate-y-[1080px]"}`} d="M1760.81 1154.48L1858.24 1052.31L1884.97 1190.94L2007.24 1120.36L1993.83 1260.9L2131.04 1227.63L2078.58 1358.7L2219.6 1365.43L2132.33 1476.41L2265.75 1522.6L2150.75 1604.5L2265.75 1686.4L2132.33 1732.59L2219.6 1843.57L2078.58 1850.3L2131.04 1981.37L1993.83 1948.1L2007.24 2088.64L1884.97 2018.06L1858.24 2156.69L1760.81 2054.52L1696.1 2180L1631.4 2054.52L1533.97 2156.69L1507.24 2018.06L1384.97 2088.64L1398.38 1948.1L1261.17 1981.37L1313.63 1850.3L1172.61 1843.57L1259.88 1732.59L1126.46 1686.4L1241.46 1604.5L1126.46 1522.6L1259.88 1476.41L1172.61 1365.43L1313.63 1358.7L1261.17 1227.63L1398.38 1260.9L1384.97 1120.36L1507.24 1190.94L1533.97 1052.31L1631.4 1154.48L1696.1 1029L1760.81 1154.48Z" fill="#EEFF00" />
                        <path className={`${openMountain ? "animate-move-left -translate-x-[450px]" : 'animate-move-right translate-x-[450px]'}`} d="M2599.42 32.3025C2618.03 14.2935 2647.57 14.2934 2666.18 32.3024L4827.63 2123.98C4858.63 2153.99 4837.4 2206.48 4794.25 2206.48H471.354C428.209 2206.48 406.97 2153.99 437.974 2123.98L2599.42 32.3025Z" fill="#3D623B" />
                        <path className={`${openMountain ? "animate-move-right translate-x-[450px]" : 'animate-move-left -translate-x-[450px]'}`} d="M1309.31 803.795C1328.46 781.545 1362.92 781.545 1382.07 803.795L1834.34 1329.25L2155.51 1024.02C2174.04 1006.41 2203.12 1006.41 2221.65 1024.02L2393.21 1187.07L2695.83 872.361C2714.72 852.721 2746.15 852.721 2765.03 872.361L3985.38 2141.48C4014.71 2171.98 3993.1 2222.75 3950.78 2222.75H2508.5C2505.6 2223.28 2502.58 2223.56 2499.45 2223.56H191.928C150.873 2223.56 128.766 2175.37 155.548 2144.25L1309.31 803.795Z" fill="#487B3C" />
                    </svg>
                    <img src={makiling} alt="" className="absolute bottom-0 left-0" />

                    <svg onClick={() => { setSelectedStory(!selectedStory) }} className={`w-full absolute left-[20%] bottom-[20%] max-w-[289px] h-auto ${selectedStory ? 'transition-opacity duration-1000 opacity-0 ease-in' : ''}`} viewBox="0 0 289 211" fill="none" xmlns="http://www.w3.org/2000/svg">
